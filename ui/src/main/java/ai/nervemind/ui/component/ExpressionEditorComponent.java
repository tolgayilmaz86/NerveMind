 ...
 */
package ai.nervemind.ui.component;
...
/**
 * Reusable ExpressionEditor component for editing expressions with variable
 * interpolation.
 *
 * <p>
 * This is a generic, reusable UI component that can be embedded in any view.
 * It extends VBox and loads its FXML using the fx:root pattern.
 * Features:
 * <ul>
...
public class ExpressionEditorComponent extends VBox {
    ...
    private static final String STYLE_SUGGESTION_VARIABLE = "expression-editor__suggestion--variable";
    private static final String STYLE_SUGGESTION_FUNCTION = "expression-editor__suggestion--function";
    ...
    private void loadFxml() {
        FXMLLoader loader = new FXMLLoader(
                getClass().getResource("/ai/nervemind/ui/view/component/ExpressionEditor.fxml"));
        loader.setRoot(this);
            ...
            protected void updateItem(String item, boolean empty) {
                ...
                if (empty || item == null) {
                    ...
                    getStyleClass().removeAll(
                            STYLE_SUGGESTION_VARIABLE,
                            STYLE_SUGGESTION_FUNCTION);
                } else {
                    setText(item);
                    getStyleClass().removeAll(
                            STYLE_SUGGESTION_VARIABLE,
                            STYLE_SUGGESTION_FUNCTION);
                    if (item.startsWith("${")) {
                        getStyleClass().add(STYLE_SUGGESTION_VARIABLE);
                    } else {
                        getStyleClass().add(STYLE_SUGGESTION_FUNCTION);
                    }
                }
            }
        });
